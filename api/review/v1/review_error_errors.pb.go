...
// 为某个枚举单独设置错误码
func IsNeedFound(err error) bool {
	if err == nil {
		return false
	}
	e := errors.FromError(err)
	return e.Reason == ErrorReason_NEED_FOUND.String() && e.Code == 401
}

// 为某个枚举单独设置错误码
func ErrorNeedFound(format string, args ...interface{}) *errors.Error {
	return errors.New(401, ErrorReason_NEED_FOUND.String(), fmt.Sprintf(format, args...))
}
...
func IsReviewNotFound(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ErrorReason_ReviewNotFound.String() && e.Code == 404
}

func ErrorReviewNotFound(format string, args ...interface{}) *errors.Error {
	return errors.New(404, ErrorReason_ReviewNotFound.String(), fmt.Sprintf(format, args...))
}
