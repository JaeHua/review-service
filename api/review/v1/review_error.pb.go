...
const (
	// 为某个枚举单独设置错误码
	ErrorReason_NEED_FOUND             ErrorReason = 0
	ErrorReason_DB_FAILED              ErrorReason = 1
	ErrorReason_ORDER_REVIEWED         ErrorReason = 2
	ErrorReason_REVIEW_ALREADY_REPLIED ErrorReason = 3
	// 水平越权
	ErrorReason_PERMISSION_DENIED ErrorReason = 4
	ErrorReason_ReviewNotFound    ErrorReason = 5
)
...
const file_api_review_v1_review_error_proto_rawDesc = "" +
	"\n" +
	" api/review/v1/review_error.proto\x12\rapi.review.v1\x1a\x13errors/errors.proto*\xb1\x01\n" +
	"\vErrorReason\x12\x14\n" +
	"\n" +
	"NEED_FOUND\x10\x00\x1a\x04\xa8E\x91\x03\x12\x13\n" +
	"\tDB_FAILED\x10\x01\x1a\x04\xa8E\xf4\x03\x12\x18\n" +
	"\x0eORDER_REVIEWED\x10\x02\x1a\x04\xa8E\x90\x03\x12 \n" +
	"\x16REVIEW_ALREADY_REPLIED\x10\x03\x1a\x04\xa8E\x90\x03\x12\x1b\n" +
	"\x11PERMISSION_DENIED\x10\x04\x1a\x04\xa8E\x93\x03\x12\x18\n" +
	"\x0eReviewNotFound\x10\x05\x1a\x04\xa8E\x94\x03\x1a\x04\xa0E\xf4\x03B2\n" +
